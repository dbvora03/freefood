...
if(process.env.NODE_ENV=="production") {
    app.use(express.static('client/build'))
    app.get('/signin', (req, res) => res.sendFile(path.resolve(__dirname,'client','build', 'index.html')));
}


app.get('/signin', (req, res) => res.sendFile(path.resolve('client/build', 'index.html')));
